...
using StarCraftCommand = starcraftbot.proxybot.Command.StarCraftCommand;
using System.Threading;
using System.Windows.Forms;
using starcraftbot_net_20052.proxybot;
namespace starcraftbot.proxybot
{
	...
	public class ProxyBot
	{
		...
		public virtual void  start()
		{
			...
			System.String[] players = line.Split(":".ToCharArray());
		...
		{
			doCommand(starcraftbot.proxybot.Command.StarCraftCommand.attackMove, unitID, x, y, 0);
		}
		...
		{
			doCommand(starcraftbot.proxybot.Command.StarCraftCommand.attackUnit, unitID, targetID, 0, 0);
		}
		...
		{
			doCommand(starcraftbot.proxybot.Command.StarCraftCommand.rightClick, unitID, x, y, 0);
		}
		...
		{
			doCommand(starcraftbot.proxybot.Command.StarCraftCommand.rightClickUnit, unitID, targetID, 0, 0);
		}
		...
		{
			doCommand(starcraftbot.proxybot.Command.StarCraftCommand.train, unitID, typeID, 0, 0);
		}
		...
		{
			doCommand(starcraftbot.proxybot.Command.StarCraftCommand.build, unitID, tx, ty, typeID);
		}
		...
		{
			doCommand(starcraftbot.proxybot.Command.StarCraftCommand.buildAddon, unitID, typeID, 0, 0);
		}
		...
		{
			doCommand(starcraftbot.proxybot.Command.StarCraftCommand.research, unitID, techTypeID, 0, 0);
		}
		...
		{
			doCommand(starcraftbot.proxybot.Command.StarCraftCommand.upgrade, unitID, upgradeTypeID, 0, 0);
		}
		...
		{
			doCommand(starcraftbot.proxybot.Command.StarCraftCommand.stop, unitID, 0, 0, 0);
		}
		...
		{
			doCommand(starcraftbot.proxybot.Command.StarCraftCommand.holdPosition, unitID, 0, 0, 0);
		}
