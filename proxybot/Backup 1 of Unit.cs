...
namespace starcraftbot.proxybot
{
	...
	public class Unit
	{
		...
		public static System.Collections.ArrayList getUnits(System.String unitData, System.Collections.Hashtable types)
		{
			System.Collections.ArrayList units = new System.Collections.ArrayList();
			
			System.String[] unitDatas = unitData.split(":");
			bool first = true;
			...
			foreach(String data in unitDatas)
			{
				...
				System.String[] attributes = data.split(";");
				Unit unit = new Unit();
				unit.id = System.Int32.Parse(attributes[0]);
				unit.playerID = System.Int32.Parse(attributes[1]);
				unit.type = types.get_Renamed(System.Int32.Parse(attributes[2]));
