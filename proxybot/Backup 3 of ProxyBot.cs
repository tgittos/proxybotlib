...
namespace starcraftbot.proxybot
{
	...
	public class ProxyBot
	{
		...
		public virtual void  start()
		{
			...
			temp_tcpListener = new System.Net.Sockets.TcpListener(System.Net.Dns.GetHostByName(System.Net.Dns.HostName).AddressList[0], port);
			...
			System.IO.StreamReader reader = new System.IO.StreamReader(new System.IO.StreamReader(clientSocket.Stream, System.Text.Encoding.Default).BaseStream, new System.IO.StreamReader(clientSocket.Stream, System.Text.Encoding.Default).CurrentEncoding);
			...
			clientSocket.Stream.Write(SupportClass.ToByteArray(temp_sbyteArray), 0, temp_sbyteArray.Length);
			...
			while (true)
			{
				...
				lock (commandQueue.SyncRoot)
				{
					...
					while (commandQueue.Count > 0 && commandsAdded < maxCommandsPerMessage)
					{
						...
						commandData.Append(":" + command.Command + ";" + command.UnitID + ";" + command.Arg0 + ";" + command.Arg1 + ";" + command.Arg2);
					}
				}
				...
				clientSocket.Stream.Write(SupportClass.ToByteArray(temp_sbyteArray2), 0, temp_sbyteArray2.Length);
			}
		}
